        ...
        Loader {
            ...
            sourceComponent: Item {
                ...
                VisualiserBars {
                    ...
                    anchors.leftMargin: GlobalConfig.bar.positioningEdge === 0 ? Visibilities.bars.get(root.screen).exclusiveZone + Tokens.spacing.small * Config.background.visualiser.spacing : Tokens.spacing.small * Config.background.visualiser.spacing
                    anchors.topMargin: GlobalConfig.bar.positioningEdge === 2 ? Visibilities.bars.get(root.screen).exclusiveZone + Tokens.spacing.small * Config.background.visualiser.spacing : Tokens.spacing.small * Config.background.visualiser.spacing
