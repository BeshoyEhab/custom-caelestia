...
class BarWorkspaces : public ConfigObject {
    ...
    CONFIG_PROPERTY(int, displayType, 1)
    ...
    CONFIG_PROPERTY(int, specialDisplayType, 2)
    ...
    CONFIG_PROPERTY(int, overviewRows, 2)
    CONFIG_PROPERTY(int, overviewColumns, 5)
    CONFIG_PROPERTY(qreal, overviewScale, 0.18)
    CONFIG_PROPERTY(bool, workspacePreviewEnabled, true)
